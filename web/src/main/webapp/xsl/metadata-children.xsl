      ...
      <xsl:with-param name="content">
        ...
        <div id="children" class="modalbox content" style="float:left;width:50%">
          ...
          <ul>
            ...
            <li class="arrow">
              <input type="checkbox" name="gmd:identificationInfo" id="identificationInfo"
                     disabled="disabled"/>
              <label for="identificationInfo"> <!-- class="identificationInfo" -->
                <xsl:value-of
                  select="/root/gui/schemas/iso19139/labels/element[@name='gmd:identificationInfo']/label"/>
              </label>
              <ul>
                <li class="arrow">
                  ...
                  <label for="pointOfContact">
                    <xsl:value-of
                      select="/root/gui/schemas/iso19139/labels/element[@name='gmd:pointOfContact']/label"/>
                  </label>
                </li>
                <li class="arrow">
                  ...
                  <label for="descriptiveKeywords">
                    <xsl:value-of
                      select="/root/gui/schemas/iso19139/labels/element[@name='gmd:descriptiveKeywords']/label"/>
                  </label>
                </li>
                <li class="arrow">
                  ...
                  <label for="extent">
                    <xsl:value-of
                      select="/root/gui/schemas/iso19139/labels/element[@name='gmd:extent']/label"/>
                  </label>
                </li>
              </ul>
            </li>
            <li class="arrow">
              ...
              <label for="metadataMaintenance">
                <xsl:value-of
                  select="/root/gui/schemas/iso19139/labels/element[@name='gmd:metadataMaintenance']/label"/>
              </label>
            </li>
            <li class="arrow">
              ...
              <label for="metadataConstraints">
                <xsl:value-of
                  select="/root/gui/schemas/iso19139/labels/element[@name='gmd:metadataConstraints']/label"/>
              </label>
            </li>
            <li class="arrow">
            ...
            <li class="arrow">
              ...
              <label for="spatialRepresentationInfo">
                <xsl:value-of
                  select="/root/gui/schemas/iso19139/labels/element[@name='gmd:spatialRepresentationInfo']/label"/>
              </label>
            </li>
            <li class="arrow">
            ...
            <li class="arrow">
              ...
              <label for="dataQualityInfo">
                <xsl:value-of
                  select="/root/gui/schemas/iso19139/labels/element[@name='gmd:dataQualityInfo']/label"/>
              </label>
            </li>
            <li class="arrow">
              ...
              <label for="applicationSchemaInfo">
                <xsl:value-of
                  select="/root/gui/schemas/iso19139/labels/element[@name='gmd:applicationSchemaInfo']/label"/>
              </label>
            </li>
            <li class="arrow">
              ...
              <label for="portrayalCatalogueInfo">
                <xsl:value-of
                  select="/root/gui/schemas/iso19139/labels/element[@name='gmd:portrayalCatalogueInfo']/label"/>
              </label>
            </li>
            <li class="arrow">
              ...
              <label for="contentInfo">
                <xsl:value-of
                  select="/root/gui/schemas/iso19139/labels/element[@name='gmd:contentInfo']/label"/>
              </label>
            </li>
            <li class="arrow">
              ...
              <label for="metadataExtensionInfo">
                <xsl:value-of
                  select="/root/gui/schemas/iso19139/labels/element[@name='gmd:metadataExtensionInfo']/label"/>
              </label>
            </li>
          </ul>
          <br/>
          <div align="center">
            <button class="content"
                    onclick="updateChildren('children','metadata.batch.update.children','{/root/gui/strings/updateChildrenFailed}')">
